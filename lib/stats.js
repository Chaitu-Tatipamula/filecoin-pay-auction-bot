...
import { getActiveAuction } from './auction.js'
import { getSwapQuote, SUSHISWAP_NATIVE_PLACEHOLDER } from './swap.js'
 ...
 */
export async function collectAndReportStats(config) {
  const { publicClient, writeApi, usdfcAddress, usdfcAddressMainnet, network } =
    config

  console.log('Collecting auction stats...')
